...
<ul class="items" itemtype="http://schema.org/BreadcrumbList" itemscope>
    ...
    <li class="breadrumb-item" itemscope itemprop="itemListElement" itemtype="http://schema.org/ListItem"> <span itemprop="name">Máy tính bảng</span>
...
<ul id="filters" class="filters">
    ...
    <li>
        <div id="box-filter-brands" class="dropdown filter-brands filter-radio">
            <button class="dropdown-toggle" data-toggle="dropdown">
                <div class="active"><i>Thương hiệu:</i>Tất cả</div>
            </button>
            <ul class="items dropdown-menu">
                <li><a href="{{ route('tablet_apple')}}" class="">Apple</a></li>
...
<section id="box-product_brand-4" class="outer box-table">
    <div class="wrapper">
        <div class="box-inner">
            ...
            <div class="box-foot">
                <a href="/tablet/{{$manufacturer->name}}" class="viewall">Xem tất cả {{count($list_product)}}  {{$category->name}} {{$manufacturer->name}}</a>
            </div>
        </div>
    </div>
</section>
