...
<ul class="items" itemtype="http://schema.org/BreadcrumbList" itemscope>
    ...
    <li class="breadrumb-item" itemscope itemprop="itemListElement" itemtype="http://schema.org/ListItem"> <span itemprop="name">Điện thoại</span>
        ...
        <div class="box-inner">
            ...
            <div class="box-body">
                <div class="products">
                    ...
                    @endphp
                    @for ($product = 0; $product < 5; $product++) @if ($list_product[$product]->manufacturer_id == $manufacturer->id)
            ...
            <div class="box-foot">
                <a href="/phone/{{$manufacturer->name}}" class="viewall">Xem tất cả {{count($list_product)}}  {{$category->name}} {{$manufacturer->name}}</a>
            </div>
        </div>
    </div>
</section>
