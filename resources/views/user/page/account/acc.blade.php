...
<meta name="keywords" content="Tài khoản">
<meta property="og:url" content="https://mobileworld.com.vn/tai-khoan.html">
...
@section('link')
<link href="https://mobileworld.com.vn/tai-khoan.html" rel="canonical">
<link href="https://mobileworld.com.vn/tai-khoan.html" rel="alternate" media="handheld">
<link id="ws-member-css" href="https://mobileworld.com.vn/ws-content/themes/mobileworld/assets/css/member.css?v=230508" rel="stylesheet" type="text/css">
...
@section('css')
<link href="{{ asset('css/account/acc.css') }}" rel="stylesheet" id="ws-global-css" type="text/css" />
@endsection
    ...
    <section class="box-title">
        <div class="wrapper">
            <ul class="nav-step step-by-step">
                <li><a href="{{route('acc')}}" class="icon-account active">Thông tin tài khoản</a></li>
            ...
            <form action="{{route('acc_update',$user->id)}}" class="account-form" method="post">
                ...
                <div class="form-wrap">
                    ...
                    <div class="account col-right">
                        <div id="field-display_name" class="form-field field-display_name fa-user"> 
                            <input type="text" name="name" value="{{$user->name}}" required="1" autofocus="1" minlength="2" id="display_name" class="form-control"> 
                            @if ($errors->has('name'))
...
<script id="ws-common-js" language="javascript" type="text/javascript">
    var lang = 'vi',
        pagenow = 'page',
        typenow = 'index',
        seourl = 'https://mobileworld.com.vn/tai-khoan.html',
...
<script id="ws-member-js" src="https://mobileworld.com.vn/ws-content/themes/mobileworld/assets/js/member.js?v=230508" language="javascript" type="text/javascript"></script>
