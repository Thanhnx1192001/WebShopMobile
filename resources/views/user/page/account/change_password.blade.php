...
<meta name="keywords" content="Đổi mật khẩu">
<meta property="og:url" content="https://mobileworld.com.vn/doi-mat-khau.html">
...
<meta property="og:image:alt" content="Đổi mật khẩu">
<meta property="fb:app_id" content="440100557569103">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="Đổi mật khẩu">
<meta name="twitter:description" content="Đổi mật khẩu">
@endsection

@section('link')
<link href="https://mobileworld.com.vn/doi-mat-khau.html" rel="canonical">
<link href="https://mobileworld.com.vn/doi-mat-khau.html" rel="alternate" media="handheld">
...
@section('css')
<link href="{{ asset('css/account/change_password.css') }}" rel="stylesheet" id="ws-global-css" type="text/css" />
@endsection
...
<main id="ws-content" class="ws-content outer">
    <section class="breadcrumb">
        <div class="wrapper">
            <ul class="items" itemtype="http://schema.org/BreadcrumbList" itemscope>
                ...
                <li class="breadrumb-item" itemscope itemprop="itemListElement" itemtype="http://schema.org/ListItem"> <span itemprop="name">Đổi mật khẩu</span>
    ...
    <section class="box-title">
        <div class="wrapper">
            <ul class="nav-step step-by-step">
                ...
                <li><a href="{{route('order_management')}}" class="icon-userorder">Quản lý đơn hàng</a></li>
                <li><a href="{{route('change_password')}}" class="icon-changepass active">Đổi mật khẩu</a></li>
    ...
    <section class="box-content">
        <div class="wrapper">
            <form action="{{route('updatePassword')}}" class="changepass-form" method="post">
                @method('PATCH')
                @csrf
                <div class="form-wrap">
                    <div id="field-pass_old" class="form-field field-pass_old">
                        <div class="form-label"> <label for="pass_old">Mật khẩu hiện tại</label></div>
                        <div class="form-input"> <input type="password" name="current_password" value="" required="1" autofocus="1" minlength="4" id="pass_old" class="form-control">
                            @if ($errors->has('current_password'))
                            <small class="form-text text-muted">{{ $errors->first('current_password') }}</small>
                            @endif
                        </div>

                    </div>
                    <div id="field-pass_new" class="form-field field-pass_new">
                        <div class="form-label"> <label for="pass_new">Nhập mật khẩu mới</label></div>
                        <div class="form-input"> <input type="password" name="new_password" value="" required="1" minlength="4" id="pass_new" class="form-control">
                            @if ($errors->has('new_password'))
                            <small class="form-text text-muted">{{ $errors->first('new_password') }}</small>
                            @endif
                        </div>
                    </div>
                    <div id="field-pass_con" class="form-field field-pass_con">
                        <div class="form-label"> <label for="pass_con">Nhập lại mật khẩu</label></div>
                        <div class="form-input"> <input type="password" name="new_password_confirmation" value="" required="1" minlength="4" id="pass_con" class="form-control">
                    ...
                    <div id="field-button" class="form-field field-button form-button">
                        <div class="form-label"> </div>
                        <div class="form-input"> <button type="submit" class="button btn-save">Lưu thay đổi</button> </div>
                    </div>
                </div>
            </form>
        </div>
...
<script id="ws-common-js" language="javascript" type="text/javascript">
    var lang = 'vi',
        pagenow = 'page',
        typenow = 'index',
        seourl = 'https://mobileworld.com.vn/doi-mat-khau.html',
