...
<main id="ws-content" class="ws-content outer">
    ...
    <section id="box-banner" class="box-banner box" data-layout="boxed">
        <div class="wrapper">
            <section id="sync-large">
                @for ($i = 0; $i < config('constants.SHOW_BANNER_MAIN'); $i++) <a href="{{$banner_main[$i]->link}}" title="{{$banner_main[$i]->title}}" target="_self" class="advertise-item advertise-160 advertise-item-slider advertise">
            ...
            <section id="sync-small">
                @for ($i = 0; $i < config('constants.SHOW_BANNER_MAIN'); $i++) <div class="item"><span>{{$banner_main[$i]->title}}</span>
        </div>
        @endfor
    </section>
    </div>
    ...
    <section id="box-slider-bottom" class="banner-slider-bottom outer" data-layout="boxed">
        <div class="wrapper">
            <section class="slider-bottom">
                @for ($i = 0; $i < config('constants.SHOW_BANNER_MINOR'); $i++) <a href="{{$banner_minor[$i]->link}}" title="{{$banner_minor[$i]->title}}" target="_self" class="advertise-item advertise-161 advertise-item-slider-bottom advertise">
    ...
    <section id="box-product_brand-4" class="outer box-table">
        <div class="wrapper">
            <div class="box-inner">
                <div class="box-head">
                    <h3>
                        <a href="/phone/{{$manufacturer->name}}" class="ws-name">
                ...
                <div class="box-body">
                    <div class="products">
                        ...
                        @endphp
                        @for ($product = 0; $product < config('constants.SHOW_PRODUCT'); $product++) @if ($list_product[$product]->manufacturer_id == $manufacturer->id)
                ...
                <div class="box-foot">
                    <a href="/phone/{{$manufacturer->name}}" class="ws-btn">Xem tất cả
                        {{count($list_product)}}
                        @foreach($categories as $category)
                        @if($category->id == $manufacturer->category_id)
                        {{$category->name}}
    ...
    <section id="box-product_new" class="box-product_new box-table">
        <div class="wrapper">
            <div class="box-inner">
                ...
                <div class="box-foot"><a href="{{route('phone')}}" class="ws-btn">Xem tất cả {{count($products)}} Sản phẩm</a></div>
            </div>
        </div>
    </section>
    ...
    <section id="box-news" class="box-news box">
        <div class="wrapper">
            ...
            <div class="box-content">
                <div class="posts">
                    @for($i=0 ; $i < config('constants.SHOW_BLOG') ; $i++) <div class="post news">
                        <div class="img">
        ...
        <div class="box-foot"><a href="/blog" class="ws-btn viewall">Xem tất cả</a></div>
        </div>
    </section>
