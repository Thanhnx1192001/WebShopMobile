        ...
        <form id="register-form" action="javascript:;" method="post">
            ...
            <div class="form-group text-left">
                <label class="ui-checkbox ui-checkbox-info">
                    ...
                    <span class="input-span"></span>Tôi đồng ý với các điều khoản bảo mật</label>
            </div>
            <div class="form-group">
                <button class="btn btn-info btn-block" type="submit">Đăng kí</button>
            </div>
            ...
            <div class="text-center">Bạn đã có tài khoản?
                <a class="color-blue" href="login.html">Đăng nhập</a>
            </div>
        </form>
    </div>
