...
@section('content')
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form action="{{route('admin_blog.update',$blogs->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
							@method('PATCH')
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="form-group">
                                        <select class="form-control" name="user_id">
                                            ...
                                            <option {{ $row->id == $blogs->user_id ? 'selected' : ''}} value="{{$row->id}}">{{$row->name}}</option>
                                            @endforeach
                                        </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="content" value="{{$blogs->content}}">
                                </div>
